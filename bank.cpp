...
public:
	...
	int validate(char name[],char id[],char pwd[],int nc)
	{
		...
		if(x==0)
		{
			cout<<endl<<"\tSorry but this id is not available!!!"<<endl;
		}
		else
		{
			if(x==1)
	...
	void remove(char name[],char id[],int nc)
	{
		...
		if(fflag==true)
		{
			...
			else
			{
				...
				cout<<"\t--------------------------"<<endl<<endl<<endl;
				find(name,id,nc);
				cout<<endl<<"\tRecord already removed"<<endl;
				fname1.open(name1, ios::out);
				fname1.close();
			}	
		}
...
public:
	admin()
	{
		...
		af<<"1:1234:Harsh:Raj:"<<endl;
		af<<"2:1234:Utkarsh:Tamarkar:"<<endl;
		af<<"3:1234:Harsh:Sharma:"<<endl;
		af<<"4:1234:K:Lokesh:";
		af.close();
		cout<<"\t--------------------------"<<endl;
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		...
		cout<<"\tBy default, id=1 & password=1234"<<endl<<endl;
		label1:
		cout<<"\tAdmin id : ";
		cin>>aid;
		cout<<"\tPassword : ";
	...
	void adminloggedin()		//after admin logged in screen;
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t     Admin Logged in"<<endl<<endl;
		...
		switch(n)
		{
			case 1: adminloggedinstaff();
					break;
			case 2: adminloggedincust();
					break;
			case 3: adminloggedintrans();
					break;
			case 4: aflag=false;
					system("clear");
					startpage();
	...
	void hirestaff()
	{
		...
		sf<<endl<<sid<<":"<<pass<<":"<<fname<<":"<<lname<<":"<<ana<<":";
		sf.close();
		system("clear");
		cout<<"\t--------------------------"<<endl;
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
	...
	void adminloggedincust()
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t     Customer Database"<<endl<<endl;
		...
		switch(n)
		{
			case 1: admincustfindfunction(name1);
					break;
			case 2: custdata();
					break;
			case 3: adminloggedin();
					break;
			case 4: system("clear");
					aflag=false;
					startpage();
	...
	void admincustfindfunction(char name[])
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t     Find a Customer"<<endl<<endl;
	...
	void adminloggedintrans()
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t    Transaction Database"<<endl<<endl;
		...
		switch(n)
		{
			case 1: admintransfindfunction(name1);
					break;
			case 2: transactiondata();
					break;
			case 3: adminloggedin();
					break;
			case 4: system("clear");
	...
	void admintransfindfunction(char name[])
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t    Find a Transaction"<<endl<<endl;
...
public:
	staff()
	{
		...
		cout<<"\tBy default, id=101 & password=1234"<<endl<<endl;
		label1:
		cout<<"\tStaff id : ";
		cin>>sid;
		cout<<"\tPassword : ";
	...
	void staffloggedin()		//after staff logged in screen;
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t    Staff Logged in"<<endl<<endl;
	...
	void addcust()
	{
		...
		sf<<endl<<cid<<":"<<pass<<":"<<accno<<":"<<fname<<":"<<lname<<":"<<ana<<":"<<bal<<":"<<sid<<":"<<"saving"<<":";
		sf.close();
		system("clear");
		cout<<"\t--------------------------"<<endl;
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
	...
	void depositcash()
	{
		...
		else
		{
			if(x==0)
			{
				cout<<endl<<"\tSorry but this account has been closed !!!"<<endl;
			}
			else
			{
				if(x==1)
				...
				{
					cout<<endl<<"\tSome problem detected!!!"<<endl;
				}
			}
		}
		cout<<endl<<"\t1. BACK"<<endl;
	...
	void updatebalance(char id1[],char id2[],int amount,char temp1[],char mode[])
	{
		...
		file1<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<sid<<":";
		file2<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<sid<<":";
		file1.close();
		file2.close();
	}
	void withdrawcash()
	...
	void checkbalance()
	{
		...
		else
		{
			...
			cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
			cout<<"\t--------------------------"<<endl<<endl;
			cout<<"\t    Balanced Checked"<<endl<<endl;
	...
	void transfer()
	{
		...
		cout<<endl<<"\tEnter Sender Customer id : ";
		cin>>id1;
		int amount;
		int x=checka(name,id1,nc);
		if(x==-1)
		{
			cout<<endl<<"\tSender Record Not Found!!!"<<endl;
		}
		else
		{
			if(x==0)
			...
			else
			{
				if(x==1)
				{
					cout<<endl<<"\tEnter Receiver Customer id : ";
					cin>>id2;
					int y=checka(name,id2,nc);
					if(y==-1)
					{
						cout<<endl<<"\tReceiver Record Not Found!!!"<<endl;
					}
					else
					{
						if(y==0)
	...
	void updatebalancetransfer(char id1[],char id2[],int amount,char temp1[],char temp3[],char mode[])
	{
		...
		file1<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<sid<<":";
		file2<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<sid<<":";
		file3<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<sid<<":";
		file1.close();
		file2.close();
		file3.close();
	}
	void transhistory()
	{
		...
		else
		{
			...
			cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
			cout<<"\t--------------------------"<<endl<<endl;
			cout<<"\t   Transaction History of "<<name<<endl<<endl;
			show(name1,nc);	
			sf.close();
		}
		cout<<endl<<endl<<"\t1. BACK"<<endl;
...
public:
	customer()
	{
		...
		cout<<"\tBy default, id=1001 & password=1234"<<endl<<endl;
		label1:
		cout<<"\tCustomer id : ";
		cin>>cid;
		cout<<"\tPassword : ";
	...
	void custloggedin()		//after customer logged in screen;
	{
		...
		cout<<"\t  BANK MANAGEMENT SYSTEM"<<endl;
		cout<<"\t--------------------------"<<endl<<endl;
		cout<<"\t     Customer Logged In"<<endl<<endl;
	...
	void checkbal()
	{
		...
		if(!sf)
		{
			cout<<endl<<"\tSome Error Detected!!!"<<endl;
			sf.close();
		}
		else
		{
		...
		else
		{
			...
			else
			{
				if(x==1)
				{
					...
					{
						cout<<endl<<"\tYou can not trnasfer money to yourself!!!"<<endl;
					}
					else
					{
						int y=checka(name,id2,nc);
	...
	void cupdatebalancetransfer(char id1[],char id2[],int amount,char temp1[],char temp3[],char mode[])
	{
		...
		file2.open(temp1, ios::app);
		file3.open(temp3, ios::app);
		file1<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<cid<<":";
		file2<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<cid<<":";
		file3<<endl<<tid<<":"<<amount<<":"<<id1<<":"<<id2<<":"<<mode<<":"<<cid<<":";
		file1.close();
		file2.close();
		file3.close();
	}
